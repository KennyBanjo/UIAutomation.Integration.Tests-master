...
namespace Automation.Core.Selenium.PageObjectPages
{
    ...
    { 
        ...
        [FindsBy(How = How.CssSelector, Using = "input[name= LLC_BI__Description__c]")]
        ...
        public SelfRegistrationPage DisplayABRSearch()
        {
            ...
            //ABRSearchPage.WaitUntilElementVisible();
            //ABRSearchPage.IsDisplayed().ShouldBeTrue("Eligibility page is not displayed");
            return new SelfRegistrationPage();
        }
